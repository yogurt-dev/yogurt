...
//			"operatorName");
    ...
    public void setMysqlInfo(String url, String username, String password, String schema) {
        this.url = url;
    ...
    public List<ColumnData> getColumnDatas(String tableName) throws SQLException {
        String SQLColumns = "SELECT distinct COLUMN_NAME, DATA_TYPE, COLUMN_COMMENT,COLUMN_KEY,CHARACTER_MAXIMUM_LENGTH" +
                ",IS_NULLABLE,COLUMN_DEFAULT  FROM information_schema.columns WHERE table_name =  '" + tableName + "' " + "and table_schema='" + schema + "' ";
        Connection con = this.getConnection();

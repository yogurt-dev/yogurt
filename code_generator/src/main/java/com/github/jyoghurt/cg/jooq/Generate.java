...
package com.github.jyoghurt.cg.jooq;
...
public class Generate implements Serializable
{
     ...
     * jOOQ API, without adding custom data className bindings to them.
     *
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the jooq property.
     *
     * @param value
     *     allowed object is
     *     {@link Boolean }
    ...
    /**
     * Generated interfaces to be implemented by jooq and/or POJOs.
     *
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Generate fluent setters in jooq, POJOs, interfaces.
     *
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Modify DefaultGeneratorStrategy behaviour to generate getters and setters in JavaBeans style in jooq, POJOs, interfaces.
     * <p>

...
public class HistoricProcessInstanceEntityManager extends AbstractManager {
     ...
     * @return
     */
    public List<HistoricProcessInstance> findHistoricProcessInstancesAndVariablesByProId(HistoricProcessInstanceQueryImpl
        ...
        if (getHistoryManager().isHistoryEnabled()) {
            ...
            List<HistoricProcessInstance> instanceList = getDbSqlSession().selectListWithRawParameterWithoutFilter("selectHistoricProcessInstancesWithVariablesByProInsId",
                    historicProcessInstanceQuery, historicProcessInstanceQuery.getFirstResult(), historicProcessInstanceQuery.getMaxResults());

 ...
 * date: 2016/11/30.
 */
public class AcceptSuccessTmpl extends BaseTpl {

    public AcceptSuccessTmpl() {
        this.setTmplId(WeChatTmplUtil.getTmplId(WechatTmplConfig.AcceptSuccessTmpl));
        this.setRemark("感谢您使用驴鱼社区的服务。");
    }
